...
parser.add_argument('--chkpt-path', metavar='CP', type=str, help='checkpoint path')
...
if __name__ == "__main__":
	...
	ray.init(include_dashboard=False, num_cpus=num_cpus, num_gpus=0)
	...
	def get_config(output_path):
		return {
			...
			"evaluation_num_workers":num_cpus-1,
			"framework": "torch",
			"output": output_path,
			# "log_level": "DEBUG",
		}
