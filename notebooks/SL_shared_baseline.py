...
def get_datasets(data, split_start = 0.7):
    ...
    num_episodes = len(data['eps_id'].unique()) - 11
...
if __name__ == "__main__":
    ...
    for t in range(epochs):
        ...
        wandb.log({"mean train loss": np.mean(train_loss), "0_train": train_loss[0], "1_train": train_loss[1], "2_train": train_loss[2], "3_train": train_loss[3]})
        wandb.log({"mean train acc": np.mean(train_acc), "0_train": train_acc[0], "1_train": train_acc[1], "2_train": train_acc[2], "3_train": train_acc[3]})
        ...
        wandb.log({"mean test loss": np.mean(test_loss), "0_test": test_loss[0], "1_test": test_loss[1], "2_test": test_loss[2], "3_test": test_loss[3]})
        wandb.log({"mean test acc": np.mean(test_acc), "0_test": test_acc[0], "1_test": test_acc[1], "2_test": test_acc[2], "3_test": test_acc[3]})
