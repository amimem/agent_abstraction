...
parser.add_argument('--P', type=int, default=1e5,
...
parser.add_argument('--data_dir', type=str,
                    default='data_a505fc258b/', help='Data directory')
...
if __name__ == '__main__':
    ...
    # assumes negative root always extraneous
    def solve_quadratic(a, b, c): return (-b+np.sqrt(b**2-4*a*c))/(2*a)
    if model_name == 'stomp':
        ...
        enc2dec_ratio = 1
        F = agent_embedding_dim
        enc_hidden_dim = int(solve_quadratic(
            (args.M+enc2dec_ratio**2)*2, (args.M*args.L+K) + (F+args.L+A)*enc2dec_ratio, N*args.M-args.P))
        dec_hidden_dim = enc2dec_ratio*enc_hidden_dim
        net = STOMPnet(
            state_space_dim,
        ...
        net = MultiChannelNet(
            ...
            hidden_layer_width=int(solve_quadratic(2, N*(A+K), -args.P)),
