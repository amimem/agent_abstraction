...
assert output_tensor.shape == torch.Size([2, 2, 3])
...
assert output_tensor_with_output_dim.shape == torch.Size([2, 2, 2, 3])
...
assert output_tensor_without_output_dim.shape == torch.Size([2, 2, 3])
